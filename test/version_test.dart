...
main() {
  ...
  test('allows()', () {
    ...
    expect(v123, doesNotAllow(new Version.parse('2.2.3'),
        new Version.parse('1.3.3'), new Version.parse('1.2.4'),
        new Version.parse('1.2.3-dev'), new Version.parse('1.2.3+build')));
  });
