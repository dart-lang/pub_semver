...
main() {
  test('any', () {
    ...
    expect(VersionConstraint.any, allows(new Version.parse('0.0.0-blah'),
  ...
  group('parse()', () {
    ...
    test('parses "any"', () {
      ...
      expect(constraint, allows(new Version.parse('0.0.0'),
          new Version.parse('1.2.3'), new Version.parse('12345.678.90')));
    });
    ...
    test('parses a ">" minimum version', () {
      ...
      expect(constraint, doesNotAllow(new Version.parse('1.2.1'),
    ...
    test('parses a ">=" minimum version', () {
      ...
      expect(constraint, allows(new Version.parse('1.2.3'),
    ...
    test('parses a "<" maximum version', () {
      ...
      expect(constraint, doesNotAllow(new Version.parse('1.2.3'),
          new Version.parse('1.2.3+foo'), new Version.parse('1.2.4')));
    });
    ...
    test('parses a "<=" maximum version', () {
      ...
      expect(constraint, allows(new Version.parse('1.2.1'),
          new Version.parse('1.2.3-build'), new Version.parse('1.2.3')));
      expect(constraint, doesNotAllow(
          new Version.parse('1.2.3+foo'), new Version.parse('1.2.4')));
    });
    ...
    test('parses a series of space-separated constraints', () {
      ...
      expect(constraint, doesNotAllow(new Version.parse('1.2.3-pre'),
    ...
    test('throws FormatException on a bad string', () {
      var bad = [
        ...
        "^foo", // Bad text after "^".
        "1.0.0 foo",
        "1.0.0foo", // Bad text after version.
  ...
  group('compatibleWith()', () {
    test('returns the range of compatible versions', () {
      ...
      expect(constraint, equals(new VersionRange(
